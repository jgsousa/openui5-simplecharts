jQuery.sap.declare("testgraph2.Component");
jQuery.sap.require("testgraph2.MyRouter");
jQuery.sap.require("sap.ui.thirdparty.d3");

sap.ui.core.UIComponent.extend("testgraph2.Component", {
    metadata: {
        name: "Testes 2",
        version: "1.0",
        includes: [],
        ...
        routing: {
            config: {
                routerClass:testgraph2.MyRouter,
                viewType: "XML",
                viewPath: "testgraph2.view",
    ...
    init: function () {
        ...
        var oRootPath = jQuery.sap.getModulePath("testgraph2");
